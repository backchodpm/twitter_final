...
while True:
    user = api.get_user('ProkorshoM')
    api.update_profile(name=f'Prokorsho Munshi|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Prokorsho Munshi|{follower_count(user)} Followers')
